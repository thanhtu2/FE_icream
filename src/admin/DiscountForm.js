      ...
      if (discountId) {
        try {
          const response = await axios.get(
            `http://localhost:4000/discounts/${discountId}`,
          );
          ...
          console.error(
            'Lỗi khi lấy thông tin mã giảm giá:',
            err.response?.data || err.message,
          );
    ...
    <Container style={{ padding: '50px' }}>
      ...
      <Form>
        <Form.Group controlId="formTitle">
          <Form.Label className="title" style={{ fontWeight: '600' }}>
            Title
          </Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group controlId="formDescription">
          <Form.Label style={{ marginTop: '15px', fontWeight: '600' }}>
            Description
          </Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group controlId="formProduct">
          ...
          <Form.Control
            ...
            required
          >
            <option value="" style={{ marginTop: '15px', fontWeight: '600' }}>
              Select a product
            </option>
            {products.map(product => (
              <option
                ...
                className="option_product_discount"
              >
